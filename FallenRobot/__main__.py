...
PM_START_TEXT = """
[❏────────────────────────❏](https://telegra.ph/file/b3445997d3710654d6680.jpg)
*├ ʜᴇʏ* {} 👋 
*├ ᴜᴩᴛɪᴍᴇ* `{}`
*├ ᴜsᴇʀs* `{}`
*├ ᴄʜᴀᴛs* `{}`
...
buttons = [
    [
        ...
        InlineKeyboardButton(text="ʜᴇʟᴘ", callback_data="gusion_"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="gusion_"),
                    ],
                ]
            ),
        )
        ...
        query.message.edit_text( 
            ...
            reply_markup=InlineKeyboardMarkup( 
                [ 
                    ...
                    [ 
                        InlineKeyboardButton(text="ᴜʙᴏᴛ", url="Https://t.me/FAIRYPREMIUM_BOT?start=new"), 
                        InlineKeyboardButton(text="ᴊᴀsᴀ ʙᴏᴛ", callback_data="source_"),
                        InlineKeyboardButton(text="ғsᴜʙ", url="Https://t.me/FSUBPREM_XBOT?start=new"), 
                    ],
                    [ 
                        InlineKeyboardButton(text="sᴛʀɪɴɢ", url="Https://t.me/ROBINSTINGBOT?start=new"), 
                        InlineKeyboardButton(text="ʟɪᴘᴋᴏʟ", url="Https://t.me/CARIFWB_ROBOT?start=new"),
                        InlineKeyboardButton(text="ᴄᴏᴘᴇᴛ", url="Https://t.me/COPETKONTEN_BOT?start=new"), 
                    ],
                    [
                        InlineKeyboardButton(text="sᴛᴏʀᴇ", url="Https://t.me/NAKAMA_ASL"),
                        InlineKeyboardButton(
                            text="ᴅᴏɴᴀᴛᴇ", callback_data="fallen_"
                        ),
                        InlineKeyboardButton(text="ʜᴀᴄᴋ", url="Https://t.me/ZORO_XNAKAMABOT?start=new"), 
                    ], 
                    [
                        InlineKeyboardButton(text="╞═════𖠁𐂃𖠁═════╡", callback_data="fallen_back"),
                    ], 
                ]
            ),
        )
        ...
        query.message.edit_text( 
            ...
            reply_markup=InlineKeyboardMarkup( 
                [ 
                    [ 
                        InlineKeyboardButton(
                            text="sᴜᴘᴘᴏʀᴛ", url="http://t.me/fairysupport" 
                        ),
                        InlineKeyboardButton( 
                            text="ᴄʜᴀɴɴᴇʟs", url="https://t.me/nakama_asl"
                        ),
                    ],
                    [
...
def Fallen_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "fallen_":
        ...
        query.message.edit_text(
            ...
            "\n\n*❏ ʏᴏᴜ ᴄᴀɴ ᴅᴏɴᴀᴛᴇ ᴠɪᴀ ᴅᴀɴᴀ 085882618717*"
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url=f"tg://user?id={OWNER_ID}"),
                        InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="https://t.me/nakama_asl"), 
                    ],
                    [
                        InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="gusion_")]]
            ),
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5657257558 and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {BOT_NAME} sᴏʀᴄᴇ ᴄᴏᴅᴇ ɪs [Luffy](https://t.me/Nakama_asl)."
